...
public class ColaboradorService {
    ...
    /**
     * Retornar todos os colaboradores  cadastradas no Banco de dados com paginação
     * @param paginacao
     * @return
     */
    ...
    /**
     * Retornar as colaboradores cadastradas no Banco de dados por id
     * @param id
     * @return
     */
     ...
     * @return
     */
    public ColaboradorDto cadastrarColaborador(ColaboradorDto dto) {
    ...
    /**
     * Atualizar o caolaborador no Banco de dados
     * @param id
     * @param dto
     * @return
     */
    ...
    /**
     * Excluiro o colaborador no Banco de dados
     * @param id
     */
